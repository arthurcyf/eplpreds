    ...
    <div className="grid lg:grid-cols-3 gap-4">
      <Card className="lg:col-span-2">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={load} className="px-2 py-1 rounded-lg border">Refresh</button>
        </div>
        ...
        {high && (
          <div className="space-y-2 text-sm">
            ...
            <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200">
              ...
              {high.best ? <div>User #{high.best.user_id} · {high.best.points} pts</div> : <div>-</div>}
            </div>
            <div className="p-3 rounded-xl bg-rose-50 border border-rose-200">
              <div className="font-medium">Tough week</div>
              {high.worst ? <div>User #{high.worst.user_id} · {high.worst.points} pts</div> : <div>-</div>}
            </div>
          </div>
        )}
      </Card>
